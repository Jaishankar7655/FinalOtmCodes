  ...
  return (
    <div className="min-h-screen bg-red-50 p-6">
      <div className="bg-gradient-to-r from-red-500 to-red-500 px-4 py-8 text-white text-center rounded-lg">
        <h1 className="text-4xl font-bold">Join OTM as a ToursRegister & Travel Professional!</h1>
        <p className="mt-2 text-red-100">
          Create unforgettable travel experiences for thousands of travelers
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              placeholder="Describe your tour packages, destinations, and the experiences you provide..."
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
            />
            {errors.about && (
              <p className="text-red-500 text-sm mt-1">
              ...
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-red-50">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <p className="text-sm text-gray-500">
                    Drop your best destination and tour photos or click to upload
                  </p>
                </div>
                <input
                  type="file"
