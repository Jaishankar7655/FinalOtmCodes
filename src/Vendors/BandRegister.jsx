  ...
  return (
    <div className="min-h-screen bg-red-50 p-6">
      <div className="bg-gradient-to-r from-red-500 to-red-500 px-4 py-8 text-white text-center rounded-lg">
        <h1 className="text-4xl font-bold">Register Your Band Services!</h1>
        <p className="mt-2 text-red-100">
          Bring your music to the stage and create an unforgettable atmosphere
          with your live band performances at weddings and events!
        </p>
      </div>
