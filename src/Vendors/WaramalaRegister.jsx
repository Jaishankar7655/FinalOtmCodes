...
const servicesData = [
  ...
  "Flower Shower Entry",
  "LED Entry",
  "Royal Elephant Entry",
  "Vintage Car Entry",
  "Musical Band Entry",
  "Fog Effect Entry",
  "Dancing Troupe Entry",
];
...
const WaramalaRegister = () => {
  ...
  <h1 className="text-4xl font-bold">Grand Warmala Entry!</h1>
  <p className="mt-2 text-yellow-100">
    Make your wedding entry unforgettable with a spectacular varmala ceremony.  
  </p>
</div>
