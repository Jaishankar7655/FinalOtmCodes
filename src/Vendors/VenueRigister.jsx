...
const VenueRigister = () => {
  ...
  return (
    <div className="min-h-screen bg-red-50 p-6">
      <div className="bg-gradient-to-r from-green-500 to-teal-500 px-4 py-8 text-white text-center rounded-lg">
  <h1 className="text-4xl font-bold">Register Your Wedding Venue!</h1>
  <p className="mt-2 text-green-100">
    Showcase your beautiful wedding venue and help couples find the perfect location for their special day.
  </p>
</div>
