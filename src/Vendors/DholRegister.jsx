  ...
  return (
    <div className="min-h-screen bg-red-50 p-6">
      <div className="bg-gradient-to-r from-red-500 to-red-500 px-4 py-8 text-white text-center rounded-lg">
        <h1 className="text-4xl font-bold">Register Your Dhol Services!</h1>
        <p className="mt-2 text-red-100">
          Add some beats and energy to the wedding celebration with your dhol
          performance. Make every moment unforgettable!
        </p>
      </div>
