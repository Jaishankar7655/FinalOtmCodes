...
const WeddingDressRegister = () => {
  ...
  return (
    ...
    <h1 className="text-4xl font-bold">Register Your Wedding Dress!</h1>
    <p className="mt-2 text-red-100">
      Showcase your stunning wedding dress collection and help brides find their perfect outfit.
    </p>
  </div>
