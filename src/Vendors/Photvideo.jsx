  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://vendor.onetouchmoments.com/vendor_controller/Vendor_bussiness",
        {
          method: "POST",
          body: formData,
    ...
    <div className="max-w-3xl mx-auto mt-10 bg-gradient-to-r from-white to-red-50 p-8 rounded-xl shadow-lg relative overflow-hidden">
      ...
      {success && (
        <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded mb-6 shadow-md">
          <div className="flex items-start">
            <svg className="h-6 w-6 mr-2 mt-0.5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {error && (
        <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded mb-6 shadow-md">
          <div className="flex items-start">
            <svg className="h-6 w-6 mr-2 mt-0.5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10" encType="multipart/form-data">
        {/* Service Info Section */}
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
          <h3 className="text-lg font-semibold text-red-700 mb-4 border-b pb-2">Service Information</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-1">Service Category</label>
              <input
                type="text"
                ...
                className={`w-full p-3 border ${
                  errors.service_cat ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.service_cat && (
                <p className="text-red-500 text-xs mt-1">{errors.service_cat.message}</p>
              )}
            </div>

            <div>
              <label className="block text-gray-700 text-sm font-medium mb-1">Vendor ID</label>
              <input
                type="text"
                {...register("vendor_id")}
            ...
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-1">Firm Name</label>
              <input
                type="text"
                {...register("firm_name", { 
                ...
                className={`w-full p-3 border ${
                  errors.firm_name ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.firm_name && (
        ...
        {/* Address Section */}
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
          <h3 className="text-lg font-semibold text-red-700 mb-4 border-b pb-2">Address Details</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border ${
                  errors.house_no ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.house_no && (
                <p className="text-red-500 text-xs mt-1">{errors.house_no.message}</p>
              )}
            </div>
            ...
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-1">Nearby Location</label>
              <input
                type="text"
                {...register("near_by", { required: "Nearby location is required" })}
                placeholder="Nearby Location"
                className={`w-full p-3 border ${
                  errors.near_by ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.near_by && (
                <p className="text-red-500 text-xs mt-1">{errors.near_by.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border ${
                  errors.district ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.district && (
            ...
            <div>
              ...
              <input
                ...
                placeholder="Pincode"
                className={`w-full p-3 border ${
                  errors.pincode ? "border-red-600 bg-red-50" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition duration-200`}
              />
              {errors.pincode && (
        ...
        {/* Features Section */}
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
          <h3 className="text-lg font-semibold text-red-700 mb-4 border-b pb-2">Service Features</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <label key={spec} className="flex items-center space-x-3 p-2 border border-gray-200 rounded-lg hover:bg-red-50 transition cursor-pointer">
                <input
                  type="checkbox"
        ...
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
          <h3 className="text-lg font-semibold text-red-700 mb-4 border-b pb-2">Media Upload</h3>
                  ...
                  {...register("images", {
                    validate: {
                      fileSize: files => {
                        ...
                        return Array.from(files).every(file => file.size <= maxSize) || 'Each image must be less than 5MB';
                      }
                    }
                  })}
                  multiple
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-red-400 transition duration-200">
                  ...
                  {...register("videos", {
                    validate: {
                      fileSize: files => {
                        ...
                        return Array.from(files).every(file => file.size <= maxSize) || 'Each video must be less than 50MB';
                      }
                    }
                  })}
                  multiple
                ...
                <label htmlFor="video-upload" className="cursor-pointer">
                  ...
                  <p className="text-xs text-gray-500 mt-2">Supported formats: MP4, MOV, AVI (Max: 50MB each)</p>
                </label>
              </div>
              {errors.videos && (
        ...
        >
          {isSubmitting && (
            <div className="absolute top-0 left-0 h-full bg-white bg-opacity-20" style={{ width: `${submitProgress}%` }}></div>
          )}
        ...
        {isSubmitting && (
          <div className="text-center text-gray-600 text-sm mt-2">
            ...
            {submitProgress >= 30 && submitProgress < 60 && "Uploading files..."}
            {submitProgress >= 60 && submitProgress < 90 && "Processing submission..."}
