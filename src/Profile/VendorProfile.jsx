          ...
          <div className="px-6 py-8">
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800">{userData.vendor_name}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 mb-8">
                ...
                >
                  <div className="text-center">
                    ...
                    <span className="mt-2 block text-sm font-medium">Add Service Profile</span>
                  </div>
                </a>
                ...
                >
                  <div className="text-center">
                    ...
                    <span className="mt-2 block text-sm font-medium">Services</span>
                  </div>
                </a>
                ...
                >
                  <div className="text-center">
                    ...
                    <span className="mt-2 block text-sm font-medium">Analytics</span>
                  </div>
                </a>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="vendor_name">Full Name</label>
                  <input
                    type="text"
                    id="vendor_name"
                    name="vendor_name"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="vendor_email">Email Address</label>
                  <input
                    type="email"
                    id="vendor_email"
                    name="vendor_email"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="vendor_phone">Phone Number</label>
                  <input
                    type="tel"
                    id="vendor_phone"
                    name="vendor_phone"
